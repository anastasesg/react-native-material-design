---
url: https://m3.material.io/components/navigation-bar/xr
lastmod: 2026-01-26
...
<!-- Video: Navigation bar behavior and placement changing when going from a 2D to a 3D experience -->
...
<!-- Video: A navigation bar orbiter centered and anchored to the bottom of the app -->
...
<!-- Video: A navigation bar orbiter placed in local context -->
...
<!-- Video: Position the navigation bar orbiter to reflect context: offset for global actions, inset for spatial panel-specific actions -->
...
> **Don't:** Avoid overlapping an inset navigation bar orbiter by more than half its height.

<!-- Video: Navigation bar orbiter inset positioning beyond the 12dp recommendation -->
...
<!-- Video: Nav bar orbiter placement that exceeds the width of its spatial panel -->
...
<!-- Video: Nav bar orbiter incorrectly placed above a spatial panel -->

## Accessibility considerations

[XR accessibility](https://developer.android.com/design/ui/xr/guides/get-started#make-app) guidelines are still evolving. XR navigation bars should follow applicable Material [nav bar accessibility standards](/components/navigation-bar/accessibility).
