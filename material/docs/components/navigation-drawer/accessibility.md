---
url: https://m3.material.io/components/navigation-drawer/accessibility
lastmod: '2026-01-26'
crawled_at: '2026-03-09T17:16:00.000Z'
category: components
...
_**Do:** Use a filled icon for the selected navigation destination to differentiate from the other destinations_
...
_**Don't:** Avoid keeping the icon style for the selected navigation destination the same as unselected destination's icons. This removes an important visual indicator of which destination is active._
...
The accessibility label for a navigation item is typically the same as the destination name. If the UI text is correctly linked, assistive tech (such as a screenreader) will read the UI text followed by the component's role.
