...
lastmod: 2026-01-26
crawled_at: 2026-03-09T17:11:00.000Z
category: components
...
_Do: Use a navigation drawer for 5 or more primary destinations, or more than 1 level of navigation hierarchy_
...
_Caution: Avoid using two navigation components on the same screen_
...
_Navigation drawers can include headers, subheads, and dividers to organize longer lists_
...
_Do: A navigation drawer opens from the left side of the screen for left-to-right languages_

### Divider (optional)

Dividers can be used to separate groups of destinations within the navigation drawer.

![Navigation drawer using horizontal dividers to separate a group of destinations](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq1xf0-12.png?alt=media&token=1d041701-d74b-4495-a337-c858a9bd81b5=s0)

_Do: Use full-width dividers (1) to separate groups of destinations_

![Navigation drawer using horizontal dividers to separate individual destinations](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq29df-13.png?alt=media&token=612b4caa-99c1-4c3b-a835-2c1ed0bda36a=s0)

_Don't: Don't use dividers to separate individual destinations_
...
![Navigation drawer using only label text for 4 destinations. Label text "Inbox" in active destination.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq3i6v-16.png?alt=media&token=e855eb07-211a-44ba-a56f-9414dce6237b=s0)

_Navigation drawers can use text labels without icons_

![Navigation drawer with 1 truncated text label.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq4gjj-17.png?alt=media&token=44f71647-6325-43c9-b93e-6a3bc059ae87=s0)

_Do: Keep text labels concise, but truncate them if they extend beyond the container width_

![Navigation drawer with 1 text label with wrapped label text.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq4tkk-18.png?alt=media&token=c152a72c-b231-4f97-81aa-1b14d827c8b9=s0)

_Don't: Don't wrap label text_
...
_Don't: Don't shrink text size in order to fit a text label on a single line_
...
![Navigation drawer with active destination "Inbox" featuring recognizable icon.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq67nf-20.png?alt=media&token=f5cdaabd-b70e-495e-9d1e-5cce1e0bb81d=s0)

_Do: Use recognizable icons when conventions exist_

![Navigation drawer with 4 destinations, 2 with text label and icon, 2 with only text label.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwoq6mto-21.png?alt=media&token=70a07030-1191-4f84-9e14-19c188d0452b=s0)

_Don't: Don't apply icons to some destinations and not others. Icons should be used for all destinations, or none._
...
<!-- Video: Use a navigation rail on tablet screens, or also allow a drawer to open and close via a menu icon -->
...
<!-- Video: When a navigation drawer is scrolled, the body content should remain stationary -->
...
<!-- Video: A navigation drawer animating on screen -->
