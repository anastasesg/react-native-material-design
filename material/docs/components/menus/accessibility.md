---
url: https://m3.material.io/components/menus/accessibility
lastmod: 2025-12-09
crawled_at: 2026-03-09T18:38:00.000Z
category: components
section: menus
...
[More on slots in menus](https://m3.material.io/components/menus/guidelines#8a1684bb-99a5-4a73-91a0-068d0b406127)
...
_Caution: Reserve the use of slots for use cases that maintain the menu's accessibility and functionality_
...
_Keyboard navigation on Android and web:_
...
_Do: Disabled menu items can receive focus_
...
_Don't: A divider or gap can't receive focus_
...
The role is [dependent on platform](#platform-roles).
