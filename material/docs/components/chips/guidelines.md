...
![4 chip types: Assist, filter, input, and suggestion.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8smcq59-01.png?alt=media&token=86cdedb7-2247-4e4b-a21c-3fc347cd550b=s0)

_There are four types of chips: Assist, filter, input, and suggestion_
...
![Chips used for "Reserve a table" and "Order delivery" in a restaurant app.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flztjonhj-3-do.png?alt=media&token=5c191d0f-005b-4934-bf3a-35e3bd671b25=s0)

_Do: Use chips to present contextual, supplemental options_

![Chips used for Save and Cancel actions in a dialog.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flztjp9f8-4-dont.png?alt=media&token=0efbb9dc-12ee-44da-b010-3180be80141b=s0)

_Don't: Avoid replacing major actions with chips. Actions that progress people to the next or previous step should always be displayed as buttons._
...
![Button labeled "Save task" in a task management app.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flztjqmoj-5-do.png?alt=media&token=3cb399af-ba05-4e3a-b9c6-771322061d20=s0)

_Do: Use buttons for the final step in a task_

![Chip labeled "Save task" in a task management app.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flztjqyzl-6-dont.png?alt=media&token=764c08a5-4a46-47a1-ab2d-b93f8a9c86fb=s0)

_Don't: Avoid using chips to finish or progress a task_
...
![Multiple chips in event reminder.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8smf6wp-07_do.png?alt=media&token=4240c858-234f-4199-95d5-b29f64dcf2c8=s0)

_Do: Chips can be scrolled horizontally_

![Single chip in event reminder.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8smfmgg-08_don't.png?alt=media&token=52f69bde-8de3-45e0-b6d1-cdbd51f10d1e=s0)

_Don't: Don't display a single chip by itself. Chips should appear in a set._
...
![4 chip types.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8smgjsw-09.png?alt=media&token=187779c4-7ddb-431f-bca1-622cad03df96=s0)

_There are four types of chips: Assist, Filter, Input, Suggestion_

| Purpose | Chip type | Rationale | Example |
| --- | --- | --- | --- |
...
![3 types of chips in an outlined style.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8smkogw-14_do.png?alt=media&token=2e20d7c0-d7ae-4960-ae3d-3ea7dc9af20c=s0)

_Do: Use an outline to define the edge of the chip's container on regular backgrounds_

![3 types of chips in an elevated style above restaurant photograph.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8sml3zk-15_do.png?alt=media&token=413b4ccf-6370-4b8c-b311-0ebfcccac584=s0)

_Do: Chips may use elevation when placed on an image_

![4 elevated chips above blank background.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm8smnajs-16_don't.png?alt=media&token=3b06b36e-ee77-4f2e-a619-9773f7844161=s0)

_Don't: Chips shouldn't be elevated when placed directly on the page_

![Elevated chip in pressed state.](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Fm9a01xre-17_don't.png?alt=media&token=525db271-6e30-413f-b3f4-d7c8d3bf0ae2=s0)

_Don't: Avoid using elevation to indicate a chip's pressed state. Instead, use the visual ripple effect._
...
![Filter chip in maps app labeled "Walking".](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flztjz5d8-17-do.png?alt=media&token=20092f2f-045e-4edf-8e14-9e78f9114f33=s0)

_Do: Keep chip labels short_

![Filter chip in maps app labeled "Walking navigation session".](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flztjzmjd-18-dont.png?alt=media&token=553c8425-a48e-4625-939b-3b1a4d3365dc=s0)

_Don't: Avoid chip labels longer than 20 characters_
...
See the [Specs tab](https://m3.material.io/components/chips/specs) for precise measurement values.
...
_Caution: In compact windows, make sure the whole chip opens the menu. Otherwise, the target area is likely too small to be accessible._
...
_Don't: Filter chips should not present only a single option_
