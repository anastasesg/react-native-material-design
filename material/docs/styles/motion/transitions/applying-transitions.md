---
url: https://m3.material.io/styles/motion/transitions/applying-transitions
lastmod: 2025-09-26
crawled_at: 2026-02-02T19:45:00.000Z
category: styles
section: motion
...
<!-- Video: Transitions with a default motion setting vs reduced motion setting -->

### Consistent

Consistently applying the right type of transition helps make apps feel cohesive and predictable to use.

<!-- Video: These four Android apps use the same forward and backward transition, making them feel like a cohesive family of apps -->
...
**Don't:** Don't animate many persistent elements independently. The various moving parts are distracting
