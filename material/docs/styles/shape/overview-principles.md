...
lastmod: 2025-09-26
crawled_at: 2026-02-02T22:30:00.000Z
category: styles
section: shape
page_type: null
status: complete
...
_[Video: Overview of Material shapes]_
...
_[Video: Shape morphing should respond to user interaction]_
...
_[Video: Shapes and motion can communicate actions in progress]_
...
_Caution: Shapes without clear meaning behind why they're different can add more visual clutter than delight_

_[Video: Essential shapes can use shape morph to communicate change]_

## Emphasize aesthetic moments with shape

_[Video: Use abstract shapes on imagery and decorative UI]_
...
_[Video: Apply motion and shape differently on each layer to give it the illusion of depth]_
