...
![A dialog in a UI screen requesting user confirmation to discard calendar event](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwj3qgpa-12.png?alt=media&token=c1a60c5e-df52-4743-ae61-26db3a690601=s0)

_Do: Use native elements, such as the standard platform dialog_

![A banner requesting user confirmation to discard a calendar event](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flwj3qva4-13.png?alt=media&token=f5d055ea-4af3-47f2-b0bf-aa5da473b342=s0)

_Don't: Be wary of using non-standard elements, such as a non-standard platform dialog to perform a standard dialog task. It requires extra testing to work well with assistive technology._
